...
public class FilterTest {
	...
	public void testFilter() {
		...
		EqualsFilter parsedEqFilter = (EqualsFilter) parsedFilter.get(0);
	...
	public void testRangeFilter() {
		...
		assertEquals("price[range]=12.42:24.56", filter.toString());
		assertEquals("12.42:24.56", filter.value().toString());
	}
}
